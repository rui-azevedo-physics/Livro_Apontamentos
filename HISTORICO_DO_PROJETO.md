...
Este documento destaca alguns marcos do desenvolvimento público do livro. O
histórico Git completo permanece a fonte cronológica mais detalhada.

| Data | Marco |
|---|---|
| 19 de junho de 2026 | Primeiros registos do livro e conclusão das secções sobre valores médios, entropia e sistemas compostos. |
| 26 de junho de 2026 | Integração do gás ideal monoatómico e do paradoxo de Gibbs, com manuscritos e figuras correspondentes. |
| 27 de junho de 2026 | Conclusão do capítulo 5 e início do capítulo 6. |
...
- [`5069a90`](https://github.com/rui-azevedo-physics/Livro_Apontamentos/commit/5069a90c13b424d23627b82a67e0c5e7915a0b5a) —
  valores médios, entropia e sistemas compostos;
- [`988d1be`](https://github.com/rui-azevedo-physics/Livro_Apontamentos/commit/988d1beba0ca226374508b283cf2cc0837651769) —
  gás ideal e paradoxo de Gibbs;
- [`c99fa7f`](https://github.com/rui-azevedo-physics/Livro_Apontamentos/commit/c99fa7f3c0a6d4567c45bac32ced903422560392) —
  início do capítulo 6;
- [`10c8c47`](https://github.com/rui-azevedo-physics/Livro_Apontamentos/commit/10c8c476edd717b43bdedd544f3d808de435724c) —
  revisão e desenvolvimento do potencial químico;
- [`053f83d`](https://github.com/rui-azevedo-physics/Livro_Apontamentos/commit/053f83dc896e780f26a3a2494989fca822d302f6) —
  fecho do capítulo 7;
- [`1cc3b6e`](https://github.com/rui-azevedo-physics/Livro_Apontamentos/commit/1cc3b6e7e08807781a403cee041e5c12c2ef44c8) —
  manuscritos originais dos capítulos 7 e 8.

As reorganizações posteriores não apagam os caminhos antigos: cada estado
anterior pode continuar a ser consultado através do respetivo commit.
